...
export default function StokTable({ bahanBaku, forecast, onEdit, onRestock, onOpname, onDelete }: Props) {
            ...
            {sorted.map((b) => {
              ...
              return (
                <tr key={b.id} className={`border-b th-border/50 hover:bg-red-50/30 dark:hover:bg-red-950/10 transition-colors ${rowWarning}`}>
                  ...
                  <td className="px-3 py-3 text-sm font-semibold th-text">{tampilanStok(b.stok, b.sat_dasar, b.isi_per_pak, b.sat_beli)}</td>
